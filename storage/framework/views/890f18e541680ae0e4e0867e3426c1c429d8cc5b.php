        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $pend_users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-primary" href="<?php echo e(url('admin/approve-user/'.$u->id)); ?>">Approve</a>
                            </td>
                        </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin/layouts.two_col', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Spring 2023\SD\xampp\htdocs\sadia\resources\views/admin/pages/admin/pending_users.blade.php ENDPATH**/ ?>