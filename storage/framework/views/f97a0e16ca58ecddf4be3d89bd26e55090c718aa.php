...
<div class="container-fluid">
    <div class="row h-50 align-items-center justify-content-center my-3" style="min-height: 30vh;">
        <div class="col-8 col-sm-6 col-md-4 col-lg-4 col-xl-6">
            <div class="bg-light rounded p-3 p-sm-3 my-1 mx-1">
                <div class=" align-items-center justify-content-between mb-2 my-2">
                    <h3 class="text-primary">Create a Student Account!</h3>
                    <br>
                ...
                <form class="user" method="post" action="<?php echo e(url('super-admin/createStudent')); ?>">
                    <?php echo csrf_field(); ?>
                    <h3>Sign Up</h3>
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control form-control-user" name="roll" id="exampleInputId" placeholder="Enter Your Full ID">
                        <label for="">Enter Your Full ID</label>
                    </div>
...
<?php echo $__env->make('admin.layouts.two_col', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Spring 2023\SD\xampp\htdocs\sadia\resources\views/admin/pages/super_admin/create_student.blade.php ENDPATH**/ ?>